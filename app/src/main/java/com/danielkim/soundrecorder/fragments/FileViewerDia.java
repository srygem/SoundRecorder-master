 ...
 */
public class FileViewerDia extends AppCompatDialogFragment {
    ...
    public static FileViewerDia newInstance(int position) {
        FileViewerDia f = new FileViewerDia();
        Bundle b = new Bundle();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View rootView=inflater.inflate(R.layout.fragment_file_viewer,null,false);
