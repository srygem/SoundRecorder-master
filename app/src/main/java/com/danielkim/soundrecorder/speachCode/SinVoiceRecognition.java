 ...
 *************************************************************************
 */
package com.danielkim.soundrecorder.speachCode;
...
public class SinVoiceRecognition implements Record.Listener, Record.Callback, VoiceRecognition.Listener, VoiceRecognition.Callback {
    ...
    private void stopRecognition() {
        ...
        // put end buffer
        Buffer.BufferData data = new Buffer.BufferData(0);
    ...
    public Buffer.BufferData getRecordBuffer() {
        Buffer.BufferData buffer = mBuffer.getEmpty();
        if (null == buffer) {
    ...
    @Override
    public void freeRecordBuffer(Buffer.BufferData buffer) {
        if (null != buffer) {
    ...
    public Buffer.BufferData getRecognitionBuffer() {
        Buffer.BufferData buffer = mBuffer.getFull();
        if (null == buffer) {
