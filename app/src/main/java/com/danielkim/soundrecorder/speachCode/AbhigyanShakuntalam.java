...
public class AbhigyanShakuntalam extends Activity implements SinVoiceRecognition.Listener, SinVoicePlayer.Listener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_abhigyan_shakuntalam );
